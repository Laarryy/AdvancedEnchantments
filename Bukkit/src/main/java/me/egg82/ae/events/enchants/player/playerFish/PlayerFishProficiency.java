package me.egg82.ae.events.enchants.player.playerFish;
...
public class PlayerFishProficiency implements Consumer<PlayerFishEvent> {
    private final Logger logger = LoggerFactory.getLogger(getClass());

    private EnchantAPI api = EnchantAPI.getInstance();

    public PlayerFishProficiency() { }

    public void accept(PlayerFishEvent event) {
